...
from deepcodecorrection.models import GPT, GPTConfig
...
class PLTrainer(pl.LightningModule):
    ...
    def plot_quantized_value(self, quantized_value):
        ...
        path_name_image = "images/" + self.random_string + ".png"
